...
{
    public class CustomeIdentityUserStore :UserStoreBase<IdentityUser,string,IdentityUserClaim<string>,
    IdentityUserLogin<string>,IdentityUserToken<string>>
    {
        public CustomeIdentityUserStore(IdentityErrorDescriber describer) : base(describer)
        {
        }
